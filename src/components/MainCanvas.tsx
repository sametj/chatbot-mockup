...
export default function MainCanvas() {
  return (
    <div className="mx-auto flex h-screen w-full flex-col bg-base-200">
      <Header />
      <main className="aspect-1 flex h-screen flex-1 overflow-auto border-b-2 border-black">
        <LeftSideBar />
        <Chat />
        <RightSideBar />
      </main>
      ...
      >
        <div className="flex flex-col gap-20 px-30 py-40">
          ...
          <div className="flex max-h-400 flex-col gap-20 overflow-auto">
            <p className="h-fit shrink-0 truncate rounded-md bg-base-200 p-8">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil
              magnam excepturi exercitationem adipisci atque repudiandae, quas
            </p>
            <p className="h-fit shrink-0 truncate rounded-md bg-base-200 p-8">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil
              magnam excepturi exercitationem adipisci atque repudiandae, quas
        ...
        <button className="btn btn-primary mx-auto">Clear Cache</button>
      </section>
    </aside>
  );
}
...
function Header() {
  return (
    <header className="aspect-1 flex w-full items-center justify-between border-b-2 border-black bg-base-300">
      <img
